        ...
        <div class="flex items-center justify-between h-20">
            <div class="flex items-center gap-x-8">
                ...
                <div class="hidden md:flex items-center gap-x-4">
                    ...
                    <a href="{{ route('mentor.slots.index') }}" class="{{ request()->routeIs('mentor.slots.*') ? 'bg-teal-50 text-teal-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50' }} px-3 py-2 rounded-sm text-sm font-medium transition-colors duration-150">
                        <span class="flex items-center gap-1.5">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            My Slots
                        </span>
                    </a>
                    <a href="{{ route('mentor.bookings.index') }}" class="{{ request()->routeIs('mentor.bookings.*') ? 'bg-teal-50 text-teal-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50' }} px-3 py-2 rounded-sm text-sm font-medium transition-colors duration-150">
                        <span class="flex items-center gap-1.5">
