        ...
        <div class="flex items-center justify-between h-20">
            <div class="flex items-center gap-x-8">
                ...
                <div class="hidden md:flex items-center gap-x-4">
                    <a href="{{ route('admin.dashboard') }}" class="{{ request()->routeIs('admin.dashboard') ? 'bg-teal-50 text-teal-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50' }} px-3 py-2 rounded-sm text-sm font-medium transition-colors duration-150">
                    ...
                    <a href="{{ route('admin.mentors.index') }}" class="{{ request()->routeIs('admin.mentors.*') ? 'bg-teal-50 text-teal-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50' }} px-3 py-2 rounded-sm text-sm font-medium transition-colors duration-150">
                        <span class="flex items-center gap-1.5">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                            Mentor Approvals
                        </span>
                    </a>
                    <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('admin.users.*') ? 'bg-teal-50 text-teal-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50' }} px-3 py-2 rounded-sm text-sm font-medium transition-colors duration-150">
                        <span class="flex items-center gap-1.5">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center gap-3 px-2 py-1.5 rounded-sm hover:bg-gray-50 transition-colors duration-150 focus:outline-none">
                            <div class="w-8 h-8 rounded-sm bg-teal-600 flex items-center justify-center text-white font-semibold text-xs shadow-sm">
